...
<article <?php post_class( 'fl-post' ); ?> id="fl-post-<?php the_ID(); ?>" itemscope="itemscope" itemtype="http://schema.org/BlogPosting">
	...
	<?php if ( ( $video || has_post_thumbnail() ) && ! empty( $show_thumbs ) ) : ?>
		<?php if ( $show_thumbs == 'above-title' ) : ?>
		<div class="fl-post-thumb">
			<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
				<?php echo wp_oembed_get( $video ) ?: get_the_post_thumbnail( 'large', [ 'itemprop' => 'image' ] ); ?>
			</a>
		</div>
		<?php endif; ?>
	<?php endif; ?>
	...
	<?php if ( ( $video || has_post_thumbnail() ) && ! empty( $show_thumbs ) ) : ?>
		...
		<div class="fl-post-thumb">
			<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
				<?php echo wp_oembed_get( $video ) ?: get_the_post_thumbnail( 'large' ); ?>
			</a>
		</div>
		<?php endif; ?>
		...
		<div class="row">
			<div class="fl-post-image-<?php echo $show_thumbs; ?>">
				<div class="fl-post-thumb">
					<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
						<?php echo wp_oembed_get( $video ) ?: get_the_post_thumbnail( $thumb_size ); ?>
					</a>
				</div>
			</div>
